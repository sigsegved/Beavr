...
class ThesisRepository:
    """
    Repository for trade thesis CRUD operations.
    ...
    def create(self, thesis: TradeThesis) -> str:
        """
        Create a new thesis.
    ...
    def get(self, thesis_id: str) -> Optional[TradeThesis]:
        """
        Get a thesis by ID.
    ...
    def get_by_symbol(self, symbol: str, status: Optional[ThesisStatus] = None) -> list[TradeThesis]:
        """
    ...
    def get_by_catalyst_date(self, target_date: date) -> list[TradeThesis]:
        """
    ...
    def update_status(self, thesis_id: str, status: ThesisStatus, position_id: Optional[int] = None) -> bool:
        """
    ...
    def update_confidence(self, thesis_id: str, confidence: float) -> bool:
        """
